...
class _PaymentMethodsWidgetState extends StateMVC<PaymentMethodsWidget> {
  ...
  _PaymentMethodsWidgetState() : super(WalletController()) {
    _con = controller;
  }
  ...
  Widget build(BuildContext context) {
    ...
    if(_con.wall!=null){
      if(_con.total>_con.wall['points']){
        list.paymentsList.removeWhere((element) {
          return element.id == "daliymaart_wallet";
        });
      }
    }
    ...
    return Scaffold(
      ...
      body:_con.total==0?Text('Loading..'): SingleChildScrollView(
