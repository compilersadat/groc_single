...
class CartController extends ControllerMVC {
    ...
    carts.forEach((cart) {
     ...
     // print(subTotal);
      cart.options.forEach((element) {
        subTotal += element.price*cart.quantity;
  ...
  Future getPromos( total) async{
   var data=await getPromoCodes(total);
    setState((){
      promos=data;
    });
   // print(promos);
  ...
  Future apply(code,total) async{
    var data=await applyCode(code,total);
    setState((){
      promos=data;
    });
  }
